...
<link rel="stylesheet" href="css/style_auto2.css">
		...
		<div class="contents">
			<div class = "left_items">
				...
				<form name="make_sche" method="post">
					...
					<br>
					<h5>출발지 입력하기</h5>
					<input type = "text" name="start_point" value="" placeholder="출발지 입력을 위해 클릭해주세요" onclick="searchAddress('S','1');">
					<br>
					<br>
					<h5>관광지 입력하기</h5>
